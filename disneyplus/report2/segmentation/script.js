...
//****** */
// Sfunciones de segementation
document.getElementById('newMedia').addEventListener('click', () => {
    alert('New media button clicked!');
  });
  
  document.getElementById('editMedia').addEventListener('click', () => {
    alert('Edit media button clicked!');
  });
  
  document.getElementById('deleteMedia').addEventListener('click', () => {
    alert('Delete media button clicked!');
  });
